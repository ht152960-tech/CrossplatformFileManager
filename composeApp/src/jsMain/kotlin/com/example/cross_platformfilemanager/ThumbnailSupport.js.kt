...
private class BrowserThumbnailGeneratorJs : ThumbnailGenerator {
    override suspend fun generateThumbnail(reference: FileReference): ThumbnailResult {
        ...
        val encodedJs: JsAny? = browserInterop().generateThumbnail(
            reference.source,
...
private fun browserInterop(): BrowserThumbnailInterop = js("window.fileAtlasBrowser")
